...
## Code
Code for running baseline and agentic experiments is available in the [FREED++ repository](freedpp/README.md).
...
## Citation
This work is currently under review for NeurIPS 2025 AI4Mat.
